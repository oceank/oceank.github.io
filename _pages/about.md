...
I am a third-year PhD student in the department of <a href="https://cse.sc.edu">Computing Science and Engineering</a> at <a href="https://www.sc.edu">University of South Carolina</a>. My research interests include *reinforcement learning*, *transfer learning*, *deep learning* and *adversarial example*.My advisor is [Pooyan Jamshidi](https://pooyanjamshidi.github.io/).  Currently, I am working with Prof. Jamshidi to enable a robot to automatically adapt itself to the environment by applying machine learning to optimally configure the robot based on a given budget.
